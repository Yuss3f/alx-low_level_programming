...
/**
 * make_shash_node - making a node for the sorted hash table
...
/**
 * add_to_sorted_list - adding a node to the sorted (by key's ASCII) linked list
...
/**
 * shash_table_set - setting a key to a value in the hash table
...
/**
 * shash_table_get - retrieving a value from the hash table
 * @ht: hash table
 * @key: key to the data
 *
